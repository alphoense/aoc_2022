...
class Tree:
    def __init__(self, name: str, parent=None, folder: bool = True, size: int = 0):
        self.name = name
        self.parent = parent
        self.size = size  # 0 means folder
        self.folder = folder
        self.children: [Tree] = []
        self.children_size = sum([item.size for item in self.children])
